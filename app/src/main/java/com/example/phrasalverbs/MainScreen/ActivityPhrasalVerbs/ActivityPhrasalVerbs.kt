...
class ActivityPhrasalVerbs : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ListName.add(
            PhrasalVerbsModel("https://previews.123rf.com/images/aliasching/aliasching1905/aliasching190500003/122384973-cat-cartoon-character-with-cheer-up-text.jpg","Cheer up")
        )
