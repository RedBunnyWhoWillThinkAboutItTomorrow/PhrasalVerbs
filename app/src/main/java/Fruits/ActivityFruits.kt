...
import ActivityPhrasalVerbs.PhrasalVerbsModel
import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.recyclerview.widget.LinearLayoutManager
import com.example.phrasalverbs.R
import ActivityPhrasalVerbs.AdapterActivityPhrasalVerbs
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ListName.add(
            PhrasalVerbsModel("https://previews.123rf.com/images/mochipet/mochipet1706/mochipet170600036/79523327-vector-illustration-in-flat-style-two-red-sweet-cherry-berries-connected-by-a-stem-healthy-vegetaria.jpg","Sweet cherry")
                ...
                ListName.add(
            PhrasalVerbsModel("http://www.svz.com/wp-content/uploads/2017/08/Red-currant-510x400.jpg","Red currant")
        )
        ListName.add(
        ...
        //RVFruits.layoutManager = LinearLayoutManage
